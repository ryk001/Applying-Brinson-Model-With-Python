# -*- coding: utf-8 -*-
"""brinson-model-demo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1w9KcubqF6opZYXR-Frk3uzIK1RkVY_Gr
...
benchmark_and_portfolio = pd.read_excel('/content/drive/MyDrive/benchmark_and_portfolio.xlsx')
...
# benchmark_total_return = pd.merge((benchmark_and_portfolio[benchmark_and_portfolio.sector=='Total'][['date', 'r_benchmark']]),benchmark_and_portfolio.date, on=['date']).rename(columns={'r_benchmark': 'return'})
